"""
Source: https://github.com/SSL92/hyperIQA/
"""
...
class HyperNet(nn.Module):
    ...
    def forward(self, img):
        ...
        out = {}
        out["pooled_semantic_features"] = res_out["pooled_semantic_features"]
...
class ResNetBackbone(nn.Module):
    ...
    def forward(self, x):
        ...
        out["pooled_semantic_features"] = self.lda4_pool(x).view(x.size(0), -1)
